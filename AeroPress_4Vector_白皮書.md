...
## 附錄 C：焙度對照表 — SCA 客觀標準與 S 型熱力學漸近曲線

焙度採用 SCA 官方分級與 Agtron 數值對照，僅保留物理與光學特徵。基準溫 (base_temp) 實作 S 型熱力學漸近曲線，精準模擬咖啡豆結構脆弱度演變：淺焙段維持高熱動能破壁，中深焙段急煞封印焦苦，極深焙段平滑觸及 80°C 物理地板。

| UI 名稱 | 內部代號 | SCA 名稱 (Agtron 粉值) | 基準溫 (base_temp) | 物理與選豆特徵 |
| --- | --- | --- | --- | --- |
| 極淺焙 | very_light | Light/Cinnamon (#85-95) | 100 | 淺肉桂色，表面皺褶多、體積小。豆質極硬。100°C 封頂動能破壁。 |
| 淺焙 | light | Medium (#75) | 98 | 栗子色，表面乾燥無油。一爆剛結束。維持高溫動能以推動甜感發展。 |
| 中淺焙 | medium_light | High (#65) | 95 | 褐棕色。一爆完全結束，皺褶撐開。台灣精品市場最大公約數，酸甜平衡基準。 |
| 中焙 | medium | City (#55) | 91 | 巧克力色。酸質退場、堅果轉強。若遇標示模糊豆，往下靠攏選此項最穩妥。 |
| 中深焙 | moderately_dark | Full City (#45) | 86 | 暗棕色帶油光。剛過二爆。系統啟動最大幅度急煞，嚴防焦苦物質瞬間爆發。 |
| 深焙 | dark | French (#35) | 82 | 表面佈滿油脂。結構極疏鬆。接近萃取底線，平滑降溫以保留糖蜜與 Body。 |
| 極深焙 | very_dark | Italian (#25) | 80 | 極亮黏膩感。觸及 80°C 物理地板。守住最低熱能以溶出基本醇厚度，防止焦炭化。 |

**S 型熱力學漸近曲線設計說明：** 本系統拒絕等差下降，採用鐘型分佈導數分配 20°C 總溫差（100°C 至 80°C）。淺焙段維持高熱動能破壁，中深焙段急煞封印焦苦，極深焙段平滑觸及物理地板。100°C 為物理天花板，確保淺焙甜感；80°C 為萃取地板，守住深焙 Body。**防呆提示：當咖啡豆外觀介於兩個焙度之間難以判斷時，請一律往下（較深）選擇。較深焙的設定會給予較保守的水溫，能有效避免過萃導致的焦澀劣變。**
