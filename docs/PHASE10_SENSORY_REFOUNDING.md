...
| 4 | ✅ 薄 Layer 1（平衡脫附式 knob→TDS/EY）→ [`models/layer1.py`](../models/layer1.py)；5 參數校準 3 實測錨點，文件 [`PHASE10_STEP4_LAYER1.md`](PHASE10_STEP4_LAYER1.md)。舊 `ey_model`/`tds_model`/`compounds` 退役（Step 5 改接線後刪）| `models/layer1.py` |
